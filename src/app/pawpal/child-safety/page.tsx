...
const LAST_UPDATED = "January 20, 2025";
const SUPPORT_EMAIL = "support@neothone.com";
    ...
    <main className="mx-auto flex min-h-dvh w-full max-w-5xl flex-col gap-12 px-6 py-16 text-white">
      ...
      <header className="space-y-6 text-center">
        ...
        <p className="mx-auto max-w-3xl text-sm text-white/70">
          Important: This policy does not replace legal advice. Please review it with your own legal counsel
          to ensure it meets all obligations in the countries where you operate.
        </p>
      </header>
      ...
      <section className="space-y-4 rounded-3xl bg-white px-6 py-10 text-[var(--color-ink)] shadow-2xl">
        ...
        <p className="text-sm text-[var(--color-muted)]">
          Violations result in removal of content, permanent bans, and—when necessary—reports to law enforcement
          or child-protection partners.
        </p>
      </section>
      ...
      <section className="grid gap-6 rounded-3xl border border-white/25 bg-white/10 p-6 text-white/80 backdrop-blur lg:grid-cols-2">
        <div className="space-y-4">
          <h2 className="text-2xl font-semibold text-white">5. Detection and Moderation</h2>
          ...
          <p>
            Our team may review public posts, profiles, and relevant chat logs when a specific report indicates potential abuse.
          </p>
        </div>
        <div className="space-y-4">
          <h2 className="text-2xl font-semibold text-white">6. How Users Can Report</h2>
          <p>We encourage all users to report any content or behavior that may involve CSAE:</p>
          <ul className="list-disc space-y-2 pl-6">
          ...
          <p className="text-xs text-white/70">
            Include descriptions, screenshots, usernames, profile links, timestamps, and any other context that helps us respond quickly.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4 rounded-3xl border border-white/25 bg-white/10 p-6 text-white/80 backdrop-blur">
        ...
        <p>
          When handling reports, we may need to preserve or share certain data. All processing complies with applicable
          laws and our Privacy Policy and is limited to what is necessary to respond and meet legal obligations.
        </p>
        <ul className="list-disc space-y-2 pl-6">
      ...
      <section className="space-y-4 rounded-3xl bg-white px-6 py-10 text-[var(--color-ink)] shadow-2xl">
        <h2 className="text-2xl font-semibold text-[var(--color-primary)]">12. Contact Us</h2>
        <p>
          If you have questions about this policy or need to report a child safety concern, please contact us:
        </p>
